...
![alt](/assets/img/clip.contra.png)
...
![alt](/assets/img/clip.zero.png)

**레이블을 자연어로 변환하는 과정**
CLIP의 추론은 고정된 번호(ID)가 아닌 **자연어**를 매개체로 한다.
...
> 어떻게 그러는가?
단순한 단어보다 문장 template가 성능이 높은 이유는 모델이 공부했던 환경을 동일하게 재현해주기 때문이다. WIT 학습 데이터가 그런 형태였다.
{: .prompt-warning }
...
![alt](/assets/img/clip.linear.png)
...
![alt](/assets/img/clip.privacy.png)
