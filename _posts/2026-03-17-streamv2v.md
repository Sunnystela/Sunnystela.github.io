---
layout: post
title: "[논문간단정리] LOOKING BACKWARD: STREAMING VIDEO-TO-VIDEO TRANSLATION WITH FEATURE BANKS"
...
$$\text{ExAttn} \;=\; \text{softmax}\!\left(\frac{Q_t \cdot [K_t,\, K_{fb}]^{T}}{\sqrt{d}}\right)\,[V_t,\, V_{fb}]$$
